...
public class ExcelUtil {
     ...
     * @throws IOException
     */
    public XSSFWorkbook loadExcel2007(String filePathAndName) throws FileNotFoundException,
            IOException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new FileNotFoundException("文件不存在：" + e.getMessage());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    /**
     * 读取第sheetNo个sheet页中第rowNo行第collNo列的数据(通过)
     *
     * @param sheetNo
     *            sheet页编号
     * @param rowNo
