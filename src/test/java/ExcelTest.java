...
//        }
     ...
     * @return
     */
    public static Map<String,String> getNewTypeMap(LinkedList<String> typeList, String newType, Map<String, String> newTypeMap) {
...
//                System.out.println("产品规格" + typeList.get(i));
     ...
     * @return
     */
    public static LinkedList<String> splitAndClearType(String type){
...
//        }
    ...
    public static void writeToExcel(Integer startRow, Integer startCol, List<Map<String, String>> newTypeMapList, String[] newRows) throws Exception {
        XSSFRow row = null;
        XSSFCell cell = null;
